    ...
    {data.map((item, index) => (
      ...
      >
        ...
        <div className="md:max-w-xs md:w-full w-[150px] px-2 pb-2 bg-white  ">
          <h2 className="text-sm font-semibold text-[#222222]">{item.title}</h2>
          <p className="text-[0.60rem] md:text-[0.65rem] text-[#4a4a4a] leading-tight tracking-tighter  whitespace-pre-line">
            {item.desc}
          </p>
        </div>
      </div>
